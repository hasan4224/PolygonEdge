 ...
 * This file demonstrates how to integrate Polygonedge with a web frontend
 */

// For React/Vue/Angular applications
export class PolygonedgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PolygonedgeClient(provider, contractAddress);
