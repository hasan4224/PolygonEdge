...
const contractABI = require("../artifacts/contracts/Polygonedge.sol/Polygonedge.json").abi;

program
    .name("polygonedge-cli")
    .description("CLI tool for Polygonedge smart contract")
    .version("1.0.0");
